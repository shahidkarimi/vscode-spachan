...
const THEME_YAML_FILE = path.join(__dirname, '..', 'src', 'spachan.yml');
...
async function build() {
    ...
    const standardThemePath = path.join(THEME_DIR, 'spachan.json');
    const softThemePath = path.join(THEME_DIR, 'spachan-soft.json');
